...
def enhance_detail_batch(face_batch, model, clip, vae, seed, steps, cfg, sampler_name, scheduler, 
    ...
    if vae_tiled_encode:
        batch_latents = nodes.VAEEncodeTiled().encode(vae, face_batch, 512)[0]
    else:
        batch_latents = nodes.VAEEncode().encode(vae, face_batch)[0]
    ...
    refined_latent = impact_sampling.ksampler_wrapper(
        ...
        noise=None, scheduler_func=scheduler_func, sampler_opt=None
    )
